    ...
    <div style={{
      ...
      <div className="glass-panel" style={{ width: '460px', padding: '3.5rem', borderRadius: '32px', zIndex: 10, border: '1px solid rgba(255,255,255,0.05)', boxShadow: '0 25px 50px -12px rgba(0, 0, 0, 0.5)' }}>
        ...
        <AnimatePresence mode="wait">
          {mode === 'token' ? (
            <motion.form id="token-panel" role="tabpanel" aria-labelledby="token" key="token" initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: 20 }} onSubmit={handleTokenSubmit} autoComplete="off" >
